    ...
    <header className="sticky top-0 z-50 w-full border-b glass shadow-elegant">
      <div className="container flex h-20 items-center justify-between">
        ...
        >
          ...
          <span className="font-bold text-2xl hidden sm:inline bg-gradient-to-r from-primary via-primary/90 to-secondary bg-clip-text text-transparent">Dripster</span>
        </button>
