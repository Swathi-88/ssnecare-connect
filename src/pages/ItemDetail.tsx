        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-primary via-primary/90 to-secondary bg-clip-text text-transparent">{item.title}</h1>
              <div className="mb-6">
                <p className="text-5xl font-bold bg-gradient-to-r from-primary via-primary/90 to-secondary bg-clip-text text-transparent">₹{item.price}</p>
                {item.category !== "buy" && (
